...
- **STARR-OMOP-deid** - Contains PHI scrubbed clinical text (NOTES) using [TiDE](https://starr.stanford.edu/methods/tide-clinical-text-safe-harbor)
- **STARR-OMOP-deid-lite** - Subset without clinical notes, used by ATLAS and ACE (Advanced Cohort Engine)

### Refresh Schedule

- **STARR-OMOP-deid**: Monthly refresh
- **STARR-OMOP-deid-lite**: Weekly refresh
...
STARR-OMOP-deid and STARR-OMOP-deid-lite are available through [self-service](https://starr.stanford.edu/self-service).
