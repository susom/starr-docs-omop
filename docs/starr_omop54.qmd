...
The [Data Model Tables](omop_data_model.qmd) page describes what each OMOP table holds and how Stanford populates it — the implementation notes that do not fit in a grid cell, one section per table. Every section links to that table's fields in the data dictionary below.
